...
sub master()
    ...
    globalAPIConstants = getJSON("https://raw.githubusercontent.com/OdyseeTeam/odysee-roku/latest-version/appConstants.json")
    if isValid(globalAPIConstants["FRONTPAGE_URL"]) = false
        globalAPIConstants["FRONTPAGE_URL"] = "https://odysee.com/$/api/content/v2/get?format=roku"
    end if
