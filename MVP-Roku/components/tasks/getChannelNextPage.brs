...
function FetchChannelNextPage(pageNum as integer)
    ...
    params = { "page_size": 48, "fee_amount": "<=0", "claim_type": ["stream"], "stream_types": ["video"], "no_totals": true, "channel_ids": [m.top.channel], "order_by": ["release_time"], "release_time": "<" + curTime.toStr(), "has_source": true }
